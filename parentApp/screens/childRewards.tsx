...
const ToDo = ({props}:any) => {
    ...
    return (
      ...
      >
        ...
        <Text style={{flex: 1, textAlign: "right", fontSize:15, marginRight:10, fontFamily: "Oswald-Light", fontWeight:"300"}}>{props.item.cost + "p"}</Text>
      </TouchableOpacity >
    )
}
...
export default function children({ route, navigation }:any) {
        ...
        function childTasks() {            
            ...
            var rewardData = DATA.rewards

            return (
                <FlatList
                    data={rewardData}
                    extraData={rewardData}
        ...
        <View style={{flex:1}}>
            ...
            <View style={globalStyle.container}>
                <View style= {{flexDirection:"row", width: "80%", justifyContent:"space-evenly"}}>
                    ...
                    onPress={() => {
                        navigation.navigate("childTaskList", {choosenChild: choosenChild})
                    }}
                    >
